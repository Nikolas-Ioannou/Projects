...
// It will be stored at the end of every block
typedef struct { //Metadata
  BF_Block* block; 
  int file_desc;      
  char fileName[20]; // The name of the file
  int  root;// The block id of the root index
  int type;// This variable determines what type of a block is(data or index).When it is 1 the block is index.If it is 0 the block is data)
} BPLUS_INFO;
